    ...
    return (
        <div className="flex flex-col gap-8 bg-gray-100 border-2 border-gray-200 container">
            ...
            <div className="flex justify-center gap-4 my-4">
                <button
                    className="carousel-button prev hover:scale-110 transition-all duration-300 ease-in-out cursor-pointer"
                    onClick={goToPrevious}><FaArrowAltCircleLeft/></button>
                <button
                    className="carousel-button next hover:scale-110 transition-all duration-300 ease-in-out cursor-pointer"
                    onClick={goToNext}><FaArrowAltCircleRight/></button>
            </div>
